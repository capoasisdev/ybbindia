    ...
    <footer className="mt-24 border-t border-border bg-sidebar text-sidebar-foreground">
      <div className="container-page grid gap-10 py-14 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm text-sidebar-foreground/70">
            <li>
              <Link to="/legal/$slug" params={{ slug: "terms" }} className="hover:text-sidebar-primary">
                Terms of use
              </Link>
            </li>
            <li>
              <Link to="/legal/$slug" params={{ slug: "privacy" }} className="hover:text-sidebar-primary">
                Privacy policy
              </Link>
            </li>
            <li>
              <Link to="/legal/$slug" params={{ slug: "refund" }} className="hover:text-sidebar-primary">
                Refund policy
              </Link>
            </li>
            <li>
