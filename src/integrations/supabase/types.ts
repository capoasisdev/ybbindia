...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      app_role: "learner" | "reviewer" | "support_admin" | "content_admin" | "super_admin";
      attempt_status: "in_progress" | "submitted" | "auto_submitted" | "cancelled";
      ...
      order_status: "created" | "pending" | "paid" | "failed" | "cancelled" | "refunded";
      ...
      submission_status:
        ...
        | "rejected";
      ticket_status: "open" | "in_progress" | "waiting_for_learner" | "resolved" | "closed";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
