      ...
      <aside className="relative hidden overflow-hidden bg-sidebar p-12 text-sidebar-foreground lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-5 text-sm leading-relaxed text-sidebar-foreground/70">
            Sign in to continue your lessons, submit assignments, take the certification examination
            ...
            {[
              {
                ...
                hint: "Learn at your own pace",
              },
              {
                icon: FileCheck2,
                label: "Reviewer-graded assignments",
                hint: "Practical, assessed work",
              },
              {
                icon: BadgeCheck,
                label: "Verifiable ABB certificate",
                hint: "Unique ID anyone can check",
              },
            ].map((item) => (
