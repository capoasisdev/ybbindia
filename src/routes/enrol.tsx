      ...
      <section className="container-page grid max-w-5xl gap-10 py-16 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <p className="mt-4 text-muted-foreground">
            Enrolment takes three steps: create your account, confirm your billing details, and
            pay securely. Access is activated the moment payment succeeds.
          </p>
        ...
        <aside className="lg:sticky lg:top-28 lg:self-start">
          <div className="rounded-2xl border border-border bg-card p-7 shadow-lift">
            ...
            <p className="mt-5 flex items-start gap-2 text-xs text-muted-foreground">
              ...
              Payments are processed securely. A GST invoice is issued automatically once payment
              is confirmed.
            </p>
          </div>
        </aside>
